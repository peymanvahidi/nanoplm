...
class DistillationTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if "teacher_embeddings" in inputs and inputs["teacher_embeddings"] is not None:
            ...
            # No teacher embeddings provided - this shouldn't happen during training
            # but might occur during evaluation/inference
    ...
    def prediction_step(
        ...
        if "teacher_embeddings" not in inputs:
            inputs["teacher_embeddings"] = None
