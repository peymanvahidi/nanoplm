#!/usr/bin/env python3
"""
ProtX CLI - Data subcommands for ProtX package
"""

import click
from pathlib import Path

from protx.data.downloader import Downloader
from protx.data.extractor import Extractor
from protx.data.shuffler import FastaShuffler
from protx.data.filter_splitor import FilterSplitor
from protx.data.dataset import ProtXDataProcessor, shard_h5_file
from protx.models.teacher import ProtT5
from protx.utils import logger, create_dirs
from protx.config.datasets import DATASET_URLS
